          ...
          >
            ...
            {sections.map((section, index) => (
              <Grid item xs={12} key={index}>
                <Box sx={{ marginBottom: 3, marginTop: 6 }}>
                  <Typography
                    variant="h2"
